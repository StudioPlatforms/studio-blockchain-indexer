...
// Indexer API URL
const INDEXER_API_URL = 'https://mainnet.studio-blockchain.com/api';
...
async function sendVerificationRequest(payload) {
  try {
    console.log(`Verifying contract ${payload.contractName} at ${payload.address}...`);
    
    const response = await axios.post(`${INDEXER_API_URL}/contracts/verify`, payload, {
      headers: {
