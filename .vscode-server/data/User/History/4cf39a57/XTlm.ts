            ...
            if (forceBlockchain) {
                ...
                for (const balance of blockchainBalances) {
                    try {
                        ...
                        logger.info(`Updated token balance for ${balance.tokenAddress} in database from blockchain (forced)`);
                    } catch (error) {
                ...
                for (const [tokenAddress, blockchainBalance] of blockchainBalancesMap.entries()) {
                    ...
                    if (dbBalance && dbBalance.balance !== blockchainBalance.balance) {
                        ...
                        try {
                            ...
                            logger.info(`Updated token balance for ${tokenAddress} in database`);
                        } catch (error) {
