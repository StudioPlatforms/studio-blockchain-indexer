...
/**
 * Read a flattened contract
 * @param {string} contractName The name of the contract
 * @returns {string} The flattened contract source code
 */
function readFlattenedContract(contractName) {
...
verifyFlattenedContract('SwapRouter')
  .then(() => {
